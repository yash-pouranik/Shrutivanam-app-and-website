  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-24 px-4 bg-[#3B2E2A]">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <p className="text-[#FF7F32] font-black uppercase tracking-widest text-xs sm:text-sm mb-4">
          {subtitle}
        </p>
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-white mb-5 sm:mb-6">
          {title}
        </h2>
        <p className="text-white/60 text-base sm:text-lg font-medium mb-8 sm:mb-10 max-w-xl mx-auto">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-3 btn-primary w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 text-base sm:text-lg shadow-2xl shadow-orange-900/20"
        >
