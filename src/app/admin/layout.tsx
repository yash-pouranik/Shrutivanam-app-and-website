  ...
  return (
    <div className="min-h-screen bg-[#0d0b1e] text-[#F5F0E8] selection:bg-[#C9A84C]/30">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-20">
         <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#1F1558]/30 blur-[120px] rounded-full" />
         <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#C9A84C]/5 blur-[100px] rounded-full" />
      </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-white/5 pb-8">
            <div>
               ...
               <p className="text-[#C8BFAD]/60 text-sm mt-1 tracking-wider uppercase font-medium">Control Center & Organization</p>
            </div>
            <div className="flex items-center gap-3 text-right">
               <div className="hidden sm:block">
                  <p className="text-[#F5F0E8] font-bold text-sm tracking-wide">{session.user.name}</p>
                  <p className="text-[#C9A84C]/60 text-[10px] uppercase font-bold tracking-widest">Master Administrator</p>
               </div>
            </div>
          </div>
