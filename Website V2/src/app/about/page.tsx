...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-50 border-b border-slate-200">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h1 className="font-[family-name:var(--font-cinzel)] text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            Preserving the <span className="text-orange-600">Sacred Flame</span>
            <br />
            of Vedic Knowledge
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-14 items-start">
            <div>
              ...
              <h2 className="font-[family-name:var(--font-cinzel)] text-3xl md:text-4xl font-bold text-slate-900 mb-6">
            ...
            <div className="space-y-4">
              {values.map((val, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="rounded-2xl p-5 bg-slate-50 border border-slate-200 flex gap-4 items-start transition-all duration-200 hover:shadow-sm"
                  >
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 bg-orange-50 border border-orange-100 text-orange-600">
                      <Icon size={18} />
                    </div>
                    <div>
                      <h3 className="font-[family-name:var(--font-cinzel)] font-semibold text-slate-900 text-sm mb-2">
                        {val.title}
                      </h3>
      ...
      {/* ─── TEACHERS ─────────────────────────────────────────────── */}
      <section id="teachers" className="section-pad px-4 sm:px-6 lg:px-8 bg-slate-50 scroll-mt-28">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-orange-600 text-sm font-semibold tracking-widest uppercase mb-4 font-[family-name:var(--font-cinzel)]">
              हमारे गुरु · Our Teachers
            </p>
            <h2 className="font-[family-name:var(--font-cinzel)] text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              The Faces Behind the Knowledge
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              Each of our teachers has walked the dual path of rigorous academic
              training and sincere spiritual practice — a rare combination that
              yields teaching of exceptional quality and depth.
            </p>
          </div>
      ...
      <section className="section-pad px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-slate-600 text-lg leading-relaxed mb-8">
            ...
            regardless of background, location, or prior knowledge. Shrutivanam
            will grow into a living community of learners, teachers, and
            practitioners — a digital gurukul for the modern age.
          </p>
          <div className="rounded-2xl p-8 bg-slate-50 border border-slate-200 inline-block">
            <p className="font-[family-name:var(--font-cormorant)] text-2xl italic text-orange-700 mb-3">
